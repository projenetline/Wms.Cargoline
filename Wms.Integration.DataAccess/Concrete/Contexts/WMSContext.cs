...
namespace Wms.Integration.DataAccess.Concrete.Contexts
{
    public partial class WMSContext : DbContext
    {
        ...
        public virtual DbSet<AdresOnerDetay> AdresOnerDetays { get; set; }
        public virtual DbSet<Arp> Arps { get; set; }
        public virtual DbSet<BaslamayanSatisSsipari> BaslamayanSatisSsiparis { get; set; }
        public virtual DbSet<Carrier> Carriers { get; set; }
        public virtual DbSet<Container> Containers { get; set; }
        public virtual DbSet<DevamSatisSsipari> DevamSatisSsiparis { get; set; }
        public virtual DbSet<DevamSatisSsiparisSatir> DevamSatisSsiparisSatirs { get; set; }
        public virtual DbSet<Document> Documents { get; set; }
        public virtual DbSet<Driver> Drivers { get; set; }
        public virtual DbSet<EmirFisiAdetDetay> EmirFisiAdetDetays { get; set; }
        public virtual DbSet<EmirFisiSatirAdet> EmirFisiSatirAdets { get; set; }
        public virtual DbSet<Erpintegration0301> Erpintegration0301s { get; set; }
        ...
        public virtual DbSet<IsmailKapama1> IsmailKapama1s { get; set; }
        public virtual DbSet<IsmailKapama2> IsmailKapama2s { get; set; }
        ...
        public virtual DbSet<Orderslip0311> Orderslip0311s { get; set; }
        ...
        public virtual DbSet<StokGenelToplam> StokGenelToplams { get; set; }
        public virtual DbSet<StokToplamlari> StokToplamlaris { get; set; }
        ...
        public virtual DbSet<SysCargoFirm> SysCargoFirms { get; set; }
        ...
        public virtual DbSet<SysErpFirm0201> SysErpFirm0201s { get; set; }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=192.168.7.252;Database=OCAK2023;user id=sa;password=net_123");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AdresOnerDetay>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("AdresOnerDetay");

                entity.Property(e => e.Address).HasMaxLength(50);

                entity.Property(e => e.Barcode).HasMaxLength(50);

                entity.Property(e => e.Code).HasMaxLength(160);
                ...
                entity.Property(e => e.Stock).HasColumnType("numeric(38, 6)");
            ...
            modelBuilder.Entity<BaslamayanSatisSsipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("BaslamayanSatisSSiparis");

                entity.Property(e => e.ArpCode).HasMaxLength(50);

                entity.Property(e => e.ArpTitle).HasMaxLength(200);

                entity.Property(e => e.CompletedRate).HasColumnType("numeric(38, 6)");

                entity.Property(e => e.DocTrackingNumber).HasMaxLength(50);

                entity.Property(e => e.DocumentNumber).HasMaxLength(50);

                entity.Property(e => e.RemainingTotal).HasColumnType("numeric(38, 6)");

                entity.Property(e => e.SlipNumber)
                    .IsRequired()
                    .HasMaxLength(50);

                entity.Property(e => e.SlipTotal).HasColumnType("numeric(38, 6)");
            });
            ...
            modelBuilder.Entity<DevamSatisSsipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("DevamSatisSSiparis");
                ...
                entity.Property(e => e.StateN).HasMaxLength(50);

                entity.Property(e => e.Title).HasMaxLength(200);
            });

            modelBuilder.Entity<DevamSatisSsiparisSatir>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("DevamSatisSSiparisSatir");
                ...
                entity.Property(e => e.ShippedTotal).HasColumnType("numeric(38, 6)");

                entity.Property(e => e.SlipNumber).HasMaxLength(50);
            });
            ...
            modelBuilder.Entity<EmirFisiAdetDetay>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EmirFisiAdetDetay");
            ...
            modelBuilder.Entity<EmirFisiSatirAdet>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EmirFisiSatirAdet");

                entity.Property(e => e.Quantity).HasColumnType("numeric(38, 8)");
            });

            modelBuilder.Entity<Erpintegration0301>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("ERPINTEGRATION0301");

                entity.Property(e => e.CreatedDate).HasColumnType("datetime");

                entity.Property(e => e.ErpEdispatch).HasColumnName("ErpEDispatch");

                entity.Property(e => e.ErpEinvoice).HasColumnName("ErpEInvoice");
            ...
            modelBuilder.Entity<IsmailKapama1>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("IsmailKapama1");
            ...
            modelBuilder.Entity<IsmailKapama2>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("IsmailKapama2");
                ...
                entity.Property(e => e.Quantity2).HasColumnType("numeric(38, 8)");
            ...
            modelBuilder.Entity<Orderslip0311>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("orderslip0311");
            ...
            modelBuilder.Entity<Slip>(entity =>
            {
                ...
                entity.Property(e => e.CargoTrackingNumber).HasMaxLength(50);
            ...
            modelBuilder.Entity<StokGenelToplam>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("StokGenelToplam");
            ...
            modelBuilder.Entity<StokToplamlari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("stok_toplamlari");
            ...
            modelBuilder.Entity<SysCargoFirm>(entity =>
            {
                entity.ToTable("SysCargoFirm");
            ...
            modelBuilder.Entity<SysErpFirm0201>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("SysErpFirm0201");
            ...
            modelBuilder.Entity<UrunTakip>(entity =>
            {
                ...
                entity.Property(e => e.PaletBarkod)
                    .HasMaxLength(200)
                    .HasColumnName("palet_barkod");
                ...
                entity.Property(e => e.StkKodu)
                    .HasMaxLength(160)
                    .HasColumnName("Stk_kodu");
